/**
  ******************************************************************************
  * File Name          : ac78xx_msp.c
  * Description        : This file provides code for the common initialization 
...
/* USER CODE BEGIN External_Functions */

/* USER CODE END External_Functions */
/* USER CODE BEGIN 0 */
