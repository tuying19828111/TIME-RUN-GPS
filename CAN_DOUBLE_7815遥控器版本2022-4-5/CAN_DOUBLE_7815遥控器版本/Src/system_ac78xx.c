...
/**
  ******************************************************************************
  * @file           : system_ac78xx.c
  * @brief          : system_ac78xx.c user space copy
  ******************************************************************************
...
* GetUUID
*
* @param[in]  param : uuidBuffer, uuid buffer
* @return none
*
...
{
    return (*(__IO uint32_t *)0x40000010);
}
